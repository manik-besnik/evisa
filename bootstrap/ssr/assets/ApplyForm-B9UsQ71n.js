...
const ApplyForm = () => {
  return /* @__PURE__ */ jsxs(Authenticated, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Admin Visa Apply | Dubai E-Visa" }),
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsx("h3", { children: "Apply Form" }),
      isPermitted(permissionEnums.ADD_DOCUMENT_TO_VISA) && /* @__PURE__ */ jsx(Link, { href: route("admin.visa-applies.index"), className: "btn-primary", children: "Visa Apply List" })
    ] }),
    /* @__PURE__ */ jsx(VisaApplyForm, { submitUrl: route("admin.visa-applies.store") })
  ] });
};
export {
