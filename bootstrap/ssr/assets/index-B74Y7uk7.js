const assetUrl = "https://dubaievisaservice.com/assets/";
const genders = [
  { id: 1, name: "Male" },
  { id: 2, name: "Female" },
  { id: 3, name: "Others" }
...
const VisaApplyTableHeading = ["No", "Name", "Passport No", "Status", "Apply Date", "Action"];
const jobApplyDocuments = [
...
export {
  VisaApplyTableHeading as V,
  visaTypes as a,
  genders as b,
  visaStatuses as c,
  documentTypes as d,
  assetUrl as e,
  jobApplyDocuments as f,
  groups as g,
  permissions as h,
  jobTypes as j,
  languageProficiency as l,
  maritalStatuses as m,
  permissionEnums as p,
  visaProcessingTypes as v
};
