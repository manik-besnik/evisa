...
export const JobDemandList = ({job_demands}) => {
    ...
    const handleConfirmDelete = () => {
        router.delete(route('agency.job-demands.destroy', jobPost.id), {
            onSuccess: () => {
                setShow(false)
            }
        })
    ...
    return (
        <Authenticated>
            ...
            <TopSection title='Job Demand List'>
                <Link href={route('agency.job-demands.create')} className='btn-primary'><FiPlus/> Add New Job Demand
                </Link>
            </TopSection>
