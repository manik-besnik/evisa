...
const JobDetailView = ({ job }) => {
    ...
    const shareUrl = `${window.location.origin}${route('job.details', job.id)}`;

    const handleFacebookShare = () => {
        // Use the Facebook Share Dialog with properly encoded URL
    ...
    return (
        <WebLayout showBgImage={true} showServiceImage={false}>
            <Head>
                ...
                <meta property="og:description" content={job.summary || `${job.type_of_work} job opportunity in ${job?.location?.name || job.job_location} with salary ${job.salary}`} />
                <meta property="og:image" content={job.thumbnail} />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta property="og:site_name" content="Dubai E-Visa" />

                {/* Twitter Card tags */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content={`${job.type_of_work} Job Details | Dubai E-Visa`} />
                <meta name="twitter:description" content={job.summary || `${job.type_of_work} job opportunity in ${job?.location?.name || job.job_location} with salary ${job.salary}`} />
                <meta name="twitter:image" content={job.thumbnail} />
            </Head>
